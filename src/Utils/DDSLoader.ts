...
class DDSLoader extends CompressedTextureLoader {
	...
	parse(buffer: any, loadMipmaps: boolean) {

		const dds = { mipmaps: [] as { data: Uint8Array; width: number; height: number }[], width: 0, height: 0, format: null as number | null, mipmapCount: 1, isCubemap: undefined as boolean | undefined };
		...
		function loadARGBMip(buffer: any, dataOffset: number, width: number, height: number) {
